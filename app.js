...
// --- MODIFICATION START ---
// Define the base path for assets when deployed on GitHub Pages.
// This should be the name of your repository, surrounded by slashes.
// Since your repo is 'AlisaAdlin', it's '/AlisaAdlin/'.
const REPO_BASE = '/AlisaAdlin/';
// --- MODIFICATION END ---
...
class App {
    constructor() {
        ...
        // --- MODIFICATION START ---
        // Use REPO_BASE for assetsPath
        this.assetsPath = `${REPO_BASE}assets/`;
        // --- MODIFICATION END ---
        ...
        // --- MODIFICATION START ---
        // Use REPO_BASE for college.json path
        fetch(`${REPO_BASE}college.json`)
            // --- MODIFICATION END ---
        ...
        // --- MODIFICATION START ---
        // Use REPO_BASE for classical music path
        this.audioLoader.load(
            `${REPO_BASE}sounds/gymnopedie_no1.mp3`, // <--- MODIFIED PATH
            // --- MODIFICATION END ---
            (buffer) => {
                this.classicalMusic.setBuffer(buffer);
                this.classicalMusic.setLoop(true);
                this.classicalMusic.setVolume(0.3);
    ...
    setEnvironment() {
        ...
        // --- MODIFICATION START ---
        // Use REPO_BASE for HDR environment map path
        loader.load(`${REPO_BASE}assets/hdr/venice_sunset_1k.hdr`, (texture) => {
            // --- MODIFICATION END ---
    ...
    loadCollege() {
        ...
        const loader = new GLTFLoader().setPath(this.assetsPath); // this.assetsPath already uses REPO_BASE
        const dracoLoader = new DRACOLoader();
        // --- MODIFICATION START ---
        // Use REPO_BASE for Draco decoder path
        dracoLoader.setDecoderPath(`${REPO_BASE}libs/three/js/draco/`);
        // --- MODIFICATION END ---
        ...
        // --- MODIFICATION START ---
        // Note: 'college.glb' path is handled by loader.setPath(this.assetsPath) in GLTFLoader
        // If your college.glb is *not* in assets/, you'd change this line directly:
        // loader.load(`${REPO_BASE}college.glb`, ...);
        // But since you have assetsPath, this is likely correct.
        loader.load(
            'college.glb',
            // --- MODIFICATION END ---
            function (gltf) {
